...
export default function NumberCard({ name, value, parameters }) {
    ...
    return (
        <div className="w-40 h-40 mr-5 bg-white rounded-2xl shadow-lg p-6 flex flex-col justify-center items-center transition-transform hover:scale-[1.02] hover:shadow-xl text-center space-y-2">
